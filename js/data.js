...
var data = {
	...
	"aboutMe" : "Hola Soy Francisco Arroyo un desarrollador web Full Stack mexicano enfocado al lenguaje C# por su rubustez, escalabilidad e interoperabilidad con otros sistemas, pero eso no es todo también he trabajado con PHP, Angular JS y VB realizando mejoras, migraciones y reparaciones de sistemas existentes. Puedo trabajar en modo freelance o por consultora.",
	...
	"experiencia": [{
		...
		"actividades": [
			...
			{ "actividad": "Propuesta de Diseño (Mockups, Wireframes))"},
			{ "actividad": "Maquetado"},
			{ "actividad": "Implementación de CMS (Joomla, Wordpress), eCommerce (Prestashop y Magento) y LCMS (Moodle)"},
			{ "actividad": "SEO  y Google Analytics"},
			{ "actividad": "Creación y conexión de perfiles de Social Media"}
			],
		"conocimientos" : [
			{ "conocimiento" : "PHP", "color" : "purple", "numero":"60" },
			{ "conocimiento" : "HTML5", "color" : "red", "numero":"95" },
			{ "conocimiento" : "CMS", "color" : "red", "numero":"85" },
			{ "conocimiento" : "SEO", "color" : "green", "numero":"78" }
		]
		},
		{
		"id" : "02",
		"puesto": " .Net  Developer",
		"logo": "img/camebra-logo.png",
		"consultora": "CAMEBRA",
		...
		"conocimientos" : 	[
			...
			{ "conocimiento" : " Entity Framework", "color" : "green", "numero":"65" }
		]
		},
		{
		"id" : "03",
		"puesto": "Desarrollador .Net C#",
		"logo": "img/inai-logo.jpg",
		...
		"conocimientos" : [
			{ "conocimiento" : ".Net Framework 4.0", "color" : "purple", "numero":"80" },
			{ "conocimiento" : "nHibernate", "color" : "red", "numero":"68" },
			{ "conocimiento" : "Web Services", "color" : "red", "numero":"95" },
			{ "conocimiento" : "MAAGTIC", "color" : "green", "numero":"80" }
		]
		},
		{
		"id" : "04",
	...
	"proyectos" : [
		{
			"nombre" : "PROCADIST", 
			"excerpt":"Programa de Capacitación a Distancia", 
			"resumen":"", 
			"cliente": "", 
			"skills":"",
			"tecnologias" : [
